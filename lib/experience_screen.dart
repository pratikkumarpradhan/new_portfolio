...
class _LearningScreenState extends State<LearningScreen> {
            ...
            builder: (context, setStateDialog) {
              return Column(
                ...
                children: [
                  ...
                  TextField(
                    controller: optionalController, // <-- new
                    decoration: const InputDecoration(
                      labelText: "Optional Text",
                    ),
                  ),
        ...
        docs.map((doc) {
          ...
          return {
            'widget': _buildInnerBox(
              ...
              isMobile,
              docId: doc.id,
              optionalText: data['optionalText'], // <-- new field
      ...
      children: List.generate(boxes.length, (index) {
        ...
        return Column(
          children: [
            ...
            if (isNewSection && index != 0) const SizedBox(height: 40),
  ...
  Widget _buildInnerBox(
    ...
    final hasOptionalText =
        optionalText != null && optionalText.trim().isNotEmpty;
                    ...
                    Text(
                      ...
                      style: GoogleFonts.tinos(
                        ...
                        fontSize:
                            isMobile
                                ? 12.5
                                : 14, // smaller than title, larger than description
                        ...
                        IconButton(
                          ...
                          onPressed:
                              index == 0
                                  ? null
                                  : () =>
                                      _swapOrder(docs[index], docs[index - 1]),
                        ),
                        IconButton(
                          icon: const Icon(
  ...
  Future<void> _swapOrder(
    ...
    batch.update(current.reference, {'order': targetOrder});
    batch.update(target.reference, {'order': currentOrder});
