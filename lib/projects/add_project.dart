...
class _AddProjectScreenState extends State<AddProjectScreen> {
  ...
  void initState() {
    ...
    if (widget.project != null) {
      ...
      _playStoreController.text = p.playStoreUrl;
      _downloadLinkController.text = p.downloadUrl;
  ...
  Future<void> _submitProject() async {
    ...
    try {
      ...
      final data = {
        ...
        'play_store_url': _playStoreController.text.trim(),
        'download_url': _downloadLinkController.text.trim(),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _styledField(
                      ...
                      "Direct Download Link (Drive/APK URL)",
                    ),
                  ],
                ),
              ),
