                    ...
                    children: [
                            ...
                            MaterialPageRoute(
                              builder:
                                  (_) => AddProjectScreen(
                                    ...
                                    documentId:
                                        docId, // pass the Firestore doc ID
                      ...
                      IconButton(
                        ...
                        onPressed: () async {
                          setState(() {
                            int newIndex =
                                index > 0 ? index - 1 : _docs.length - 1;
                      ...
                      IconButton(
                        ...
                        onPressed: () async {
                          setState(() {
                            int newIndex =
                                index < _docs.length - 1 ? index + 1 : 0;
                            final temp = _docs[newIndex];
                            _docs[newIndex] = _docs[index];
                            _docs[index] = temp;
                          });
...
class PhoneMockupNetwork extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return PhoneMockup(imagePath: imageUrl, isNetwork: true);
  }
}
